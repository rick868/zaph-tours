import { Container, Typography, Grid, Box, Stack, Paper } from '@mui/material';
...
const testimonials = [
  { id: 'john-kimani', quote: "Zaph Tours made our safari unforgettable!", author: "John K." },
  { id: 'sarah-kamau', quote: "Excellent service and amazing destinations.", author: "Sarah K." },
  { id: 'mike-peters', quote: "Highly recommend for adventure lovers.", author: "Mike P." }
];
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ mb: 6 }}>
          ...
          {testimonials.map(({ id, quote, author }) => (
            <Box key={id} sx={{ mb: 2, fontStyle: 'italic' }}>
              “{quote}” — {author}
            </Box>
          ))}
        </Box>
